...
# -----------------------------------------------------------------------------
# File: api/routes.py
# Purpose: Legacy FastAPI route handlers kept for compatibility and migration safety.
# Status: Legacy path; not the primary launcher flow.
# Responsibilities:
...
# Sidecar Contracts:
# - Do not interfere with launcher argv/env contracts.
# - Keep behavior stable for any remaining legacy callers.
# -----------------------------------------------------------------------------
