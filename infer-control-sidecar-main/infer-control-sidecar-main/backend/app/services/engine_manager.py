...
# -----------------------------------------------------------------------------
# File: services/engine_manager.py
# Purpose: Legacy async engine manager that writes shared-volume command artifacts and checks readiness.
# Status: Legacy compatibility module; launcher flow is primary.
# Responsibilities:
...
# Sidecar Contracts:
# - Keep shared-volume write behavior safe.
# - Avoid conflicting with launcher-owned process supervision.
# -----------------------------------------------------------------------------
import asyncio
import logging
import httpx
