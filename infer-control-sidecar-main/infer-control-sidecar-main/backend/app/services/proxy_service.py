...
# Purpose: Legacy proxy management helpers for startup checks and service lifecycle integration.
# Status: Legacy module kept during migration.
# Responsibilities:
...
# Sidecar Contracts:
# - Avoid side effects that conflict with launcher-managed proxy process.
# - Preserve behavior for any remaining old callers.
# -----------------------------------------------------------------------------
