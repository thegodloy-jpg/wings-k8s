...
# -----------------------------------------------------------------------------
# File: utils/wings_file_utils.py
# Purpose: Compatibility copy of wings file utility helpers retained during migration.
# Status: Temporary compatibility module.
# Responsibilities:
...
# Sidecar Contracts:
# - Prefer converging toward a single file_utils implementation.
# - Avoid conflicting helper behavior across duplicated modules.
# -----------------------------------------------------------------------------
