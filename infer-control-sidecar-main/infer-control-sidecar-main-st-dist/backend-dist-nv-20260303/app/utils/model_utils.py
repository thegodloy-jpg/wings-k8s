...
# Purpose: Model metadata parsing and architecture identification helpers.
# Status: Active reused utility in command generation paths.
# Responsibilities:
...
# Sidecar Contracts:
# - Model identification must remain deterministic.
# - Keep parser behavior backward compatible.
# -----------------------------------------------------------------------------
