...
# -----------------------------------------------------------------------------
# File: utils/device_utils.py
# Purpose: Device-level helper methods for hardware capability checks and resource introspection.
...
# Sidecar Contracts:
# - Hardware probing should degrade gracefully.
# - Avoid assumptions that break across heterogeneous nodes.
# -----------------------------------------------------------------------------
